...
Qualitative comparison (side-by-side) for Test 1 against Fig. 4.7 “Test 1: Exact solution for density, velocity, pressure, and specific internal energy at time t = 0.25” from Toro’s *Riemann Solvers for Fluid Dynamics*:

![Test 1 Comparison - Error Loading](https://i.imgur.com/yS4XTAc.png)

Qualitative comparison (side-by-side) for Test 3 against Fig. 4.9 “Test 3: Exact solution for density, velocity, pressure, and specific internal energy at time t = 0.012” from Toro’s *Riemann Solvers for Fluid Dynamics*:
